  ...
  return (
    <div className="py-20 bg-gradient-to-br from-hackathon-purple/5 to-hackathon-lightPurple/5">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold mb-4 text-hackathon-purple">Event Schedule</h2>
          <p className="text-lg text-gray-600">Two days of innovation, learning, and creation</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {schedule.map((day, dayIndex) => (
            ...
            >
              <h3 className="text-2xl font-bold mb-6 text-hackathon-purple">{day.day}</h3>
              <div className="space-y-4">
                {day.events.map((event, eventIndex) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="flex items-center space-x-4 p-3 rounded-lg hover:bg-hackathon-lightPurple/10 transition-colors duration-300"
                  >
                    <span className="text-hackathon-purple font-medium">{event.time}</span>
